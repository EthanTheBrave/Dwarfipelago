...
Your progress is measured by **War Readiness** level (1-10). Readiness rises as you receive **Military Training** items from your multiworld partners - there are **ten** of them. Each one:
...
Once the campaign begins, with you receiving your first **Military Training**, your fortress is **raided periodically** (you'll get a short warning before each attack). The strength of each raid **scales with your current War Readiness** - the further along your war effort, the more dangerous they become. Anything the attackers drop is yours to keep. Keep your military equipped and drilled; these raids are how the campaign builds toward the finale.

Your first bout with the **beast's armies** will be a scouting pack of **Kobolds**, lightly armed and pitifully trained in combat. 
Still, take care as an **unprepared** fort can fall without a moment's notice.
...
- Setup a **metal industry early** - you need it for the barracks furniture and for replacing battle losses.
...
- Keep your fortress well defended with **traps** and **moats** - not every threat fights with steel. 
...
> Energy Link's **call a caravan** does *not* summon the gorlaks - it brings **your own civilization's** trade caravan early, which carries no AP goods. There is no way to hurry the Archipelago caravan; it visits on its own schedule once you have made contact.
...
> The mod ships 50 placeholder materials and writes this seed's real name and price into
> them while your fortress runs, so any world generated with Dwarfipelago enabled works —
> connecting the client before world gen is not required (the client also bakes the same
> values into the raws as a fallback). A world generated with a mod build *older* than the
> shop materials has nothing to write into: its goods trade unnamed at a flat price, and
> the mod logs that to `dwarfipelago.log`. Generate a new world with the current mod.
...
Energy Link connects your fortress to the multiworld's shared energy pool. You contribute surplus production into the pool, and spend energy to call one of your own civilization's caravans early when you need to trade.
...
Spend energy from the pool to **request one of your own civilization's caravans** before its normal seasonal arrival. (This is a dwarven trade caravan, not the Archipelago gorlaks - see Merchant's Shop.) The mod calculates the energy cost, the client deducts it from the shared pool if you can afford it, and the caravan is then spawned and arrives - leaving again on its own schedule like any normal caravan. If the pool can't cover the cost, the request is declined.
