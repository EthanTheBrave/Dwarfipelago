...
Connecting the client first is the smoothest path: it refreshes the world gen preset,
reinstalls the mod so world gen reads current files, and opens Dwarf Fortress for you.

1. Click **Dwarf Fortress Client** in the Archipelago launcher and connect to your server
2. DF opens on its own — you do not need the launcher's **Dwarf Fortress** button
