    ...
    async def _sync_slot_data(self):
        ...
        if seed_is_fresh or current_seed == str(self.seed):
            ...
            if versions_compatible(self.version, script_version):
                ...
                logger.error(f'Your APworld and DF mod are not compatible: seed generated by version {self.version}, DF mod version {script_version}. These are on different datapackages - update both to matching versions (or re-generate) before playing.')
        else:
