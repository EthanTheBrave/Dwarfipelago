...
USEFUL_ITEMS: list[ItemData] = [
    ...
    ItemData("Raw Adamantine",         BASE_ID + 513, ItemClassification.useful),
...
FILLER_ITEMS: list[ItemData] = [
    ...
    ItemData("Stone Slab",             BASE_ID + 539, ItemClassification.filler, weight=10),
...
CRAFT_ITEMS: list[ItemData] = [ #commented items people should get when getting the blueprints
    ...
    ItemData("Menacing Spike Permit", BASE_ID + 1003, ItemClassification.progression),
    ItemData("Spiked Ball Permit", BASE_ID + 1004, ItemClassification.progression),
    ...
    ItemData("Cap Permit", BASE_ID + 1077, ItemClassification.progression),
    ItemData("Hood Permit", BASE_ID + 1078, ItemClassification.progression),
    ItemData("Shirt Permit", BASE_ID + 1079, ItemClassification.progression),
    ItemData("Vest Permit", BASE_ID + 1080, ItemClassification.progression),
    ItemData("Gauntlets Permit", BASE_ID + 1081, ItemClassification.progression),
    ItemData("Coat Permit", BASE_ID + 1082, ItemClassification.progression),
    ItemData("Cloak Permit", BASE_ID + 1083, ItemClassification.progression),
    ItemData("Leather Armor Permit", BASE_ID + 1084, ItemClassification.progression),
    ...
    ItemData("Mail Shirt Permit", BASE_ID + 1104, ItemClassification.progression),
    ItemData("Breastplate Permit", BASE_ID + 1105, ItemClassification.progression),
    ItemData("Gloves Permit", BASE_ID + 1106, ItemClassification.progression),
    ItemData("Mittens Permit", BASE_ID + 1107, ItemClassification.progression),
    ItemData("Loincloth Permit", BASE_ID + 1108, ItemClassification.progression),
    ItemData("Trousers Permit", BASE_ID + 1109, ItemClassification.progression),
    ItemData("Leggings Permit", BASE_ID + 1110, ItemClassification.progression),
    ItemData("Greaves Permit", BASE_ID + 1111, ItemClassification.progression),
    ItemData("Socks Permit", BASE_ID + 1112, ItemClassification.progression),
    ItemData("Shoes Permit", BASE_ID + 1113, ItemClassification.progression),
    ItemData("Low Boots Permit", BASE_ID + 1114, ItemClassification.progression),
    ItemData("High Boots Permit", BASE_ID + 1115, ItemClassification.progression),
    ItemData("Display Case Permit", BASE_ID + 1116, ItemClassification.progression),
    ItemData("Backpack Permit", BASE_ID + 1117, ItemClassification.progression),
    ItemData("Quiver Permit", BASE_ID + 1118, ItemClassification.progression),
    ItemData("Bolt Thrower Parts Permit", BASE_ID + 1119, ItemClassification.progression),
    ItemData("Amulet Permit", BASE_ID + 1120, ItemClassification.progression),
    ItemData("Bracelet Permit", BASE_ID + 1121, ItemClassification.progression),
    ItemData("Crown Permit", BASE_ID + 1122, ItemClassification.progression),
    ItemData("Die Permit", BASE_ID + 1123, ItemClassification.progression),
    ItemData("Earring Permit", BASE_ID + 1124, ItemClassification.progression),
    ItemData("Figurine Permit", BASE_ID + 1125, ItemClassification.progression),
    ItemData("Nest Box Permit", BASE_ID + 1126, ItemClassification.progression),
    ItemData("Ring Permit", BASE_ID + 1127, ItemClassification.progression),
    ItemData("Scepter Permit", BASE_ID + 1128, ItemClassification.progression),
    ItemData("Quire Permit", BASE_ID + 1129, ItemClassification.progression),
    ItemData("Scroll Permit", BASE_ID + 1130, ItemClassification.progression),
